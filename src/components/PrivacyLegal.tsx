...
function PrivacyDataBody() {
  return (
    <>
      <p>
        Biblos est en <strong>phase de test</strong>. Les données que tu
        confies à l’app servent uniquement à faire fonctionner la lecture, les
        plans, les flashcards et ton profil.
      </p>
      ...
      <p>
        Ces informations restent dans un <strong>espace privé</strong> de
        l’application (appareil + synchronisation technique du projet).{" "}
      ...
      <p>
        ...
        effacés pendant le développement. Pour une question ou une demande liée
        à tes données, utilise « Contacter l’admin ».
      </p>
    </>
  );
}
      ...
      <div className="privacy-gate-card">
        <div className="privacy-gate-scroll">
          ...
          <p className="privacy-gate-lead muted">
            L’application en phase de test. Tes données restent privées et ne
            sont pas partagées avec des tiers. Elles servent uniquement à l’app.
          </p>
